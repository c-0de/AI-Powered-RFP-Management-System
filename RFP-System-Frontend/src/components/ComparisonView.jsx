                                ...
                                <div className="mt-6 bg-white rounded-xl p-6 border border-indigo-100 shadow-sm relative group">
                                    ...
                                    <div className="prose prose-sm max-w-none text-slate-800 leading-relaxed">
                                        <ReactMarkdown
                                            remarkPlugins={[remarkGfm]}
                                            components={{
                                                h1: ({ node, ...props }) => <h1 className="text-xl font-bold mb-3 mt-4 text-indigo-900 border-b border-indigo-100 pb-2" {...props} />,
                                                h2: ({ node, ...props }) => <h2 className="text-lg font-bold mb-2 mt-4 text-indigo-900" {...props} />,
                                                h3: ({ node, ...props }) => <h3 className="text-base font-bold mb-2 mt-3 text-indigo-800" {...props} />,
                                                p: ({ node, ...props }) => <p className="mb-3 text-slate-700 leading-relaxed last:mb-0" {...props} />,
                                                ul: ({ node, ...props }) => <ul className="list-disc pl-5 mb-3 space-y-1 text-slate-700" {...props} />,
                                                ol: ({ node, ...props }) => <ol className="list-decimal pl-5 mb-3 space-y-1 text-slate-700" {...props} />,
                                                li: ({ node, ...props }) => <li className="pl-1" {...props} />,
                                                blockquote: ({ node, ...props }) => <blockquote className="border-l-4 border-indigo-500 pl-4 py-1 my-3 bg-indigo-50 italic text-indigo-700 rounded-r" {...props} />,
                                                pre: ({ node, ...props }) => <pre className="bg-slate-900 text-slate-50 p-3 rounded-lg mb-3 overflow-x-auto text-sm" {...props} />,
                                                code: ({ node, ...props }) => <code className="font-mono text-sm bg-slate-100 px-1 py-0.5 rounded text-indigo-600" {...props} />,
